...
input_modality = dict(use_lidar=False,
                      ...
                      use_map=False,
                      use_external=True)
model = dict(type="Petr3DExport",
             use_grid_mask=True,
             img_backbone=dict(type="VoVNetCP",
                               spec_name="V-99-eSE",
                               norm_eval=True,
                               frozen_stages=-1,
                               input_ch=3,
             ...
             img_neck=dict(type="CPFPN",
                           ...
                           out_channels=256,
                           num_outs=2),
             pts_bbox_head=dict(type="PETRHeadExport",
                                img_height=320,
                                img_width=800,
                                num_classes=10,
                                in_channels=256,
                                ...
                                transformer=dict(type="PETRTransformer",
                                                 decoder=dict(type="PETRTransformerDecoder",
                                                              ...
                                                              num_layers=6,
                                                              transformerlayers=dict(type="PETRTransformerDecoderLayer",
...
ida_aug_conf = {"resize_lim": (0.47, 0.625),
                "final_dim": (320, 800),
                "bot_pct_lim": (0.0, 0.0),
                "rot_lim": (0.0, 0.0),
                "H": 900,
                "W": 1600,
                "rand_flip": True}
train_pipeline = [dict(type="LoadMultiViewImageFromFiles",
                       to_float32=True),
...
test_pipeline = [dict(type="LoadMultiViewImageFromFiles",
                      to_float32=True),
                 dict(type="ResizeCropFlipImage",
                      data_aug_conf=ida_aug_conf,
                      training=False),
                 ...
                 dict(type="MultiScaleFlipAug3D",
                      ...
                      pts_scale_ratio=1,
                      flip=False,
                      transforms=[dict(type="DefaultFormatBundle3D",
                                       class_names=class_names,
                                       with_label=False),
                                  dict(type="Collect3D",
                                       keys=["img"])])]
data = dict(samples_per_gpu=1,
            ...
            train=dict(type=dataset_type,
                       data_root=data_root,
                       ann_file=data_root + "nuscenes_info_train.pkl",
