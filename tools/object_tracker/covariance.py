...
class Covariance(object):
    def __init__(self,
        ...
        NUSCENES_TRACKING_NAMES = ["bicycle", "bus", "car", "motocycle", "pedestrian", "trailer", "truck"]
        ...
        if covariance_id == 0:
            ...
            P = {"bicycle": [0.05390982, 0.05039431, 0.01863044, 1.29464435, 0.02713823, 0.01169572, 0.01295084, 0.04560422, 0.04097244, 0.01725477, 1.21635902],
                 ...
                 "motocycle": [0.04052819, 0.0398904 , 0.01511711, 1.06442726, 0.03291016, 0.00957574, 0.0111605 , 0.0437039 , 0.04327734, 0.01465631, 1.30414345],
            ...
            Q = {"bicycle": [1.98881347e-02, 1.36552276e-02, 5.10175742e-03, 1.33430252e-01, 0, 0, 0, 1.98881347e-02, 1.36552276e-02, 5.10175742e-03, 1.33430252e-01],
            ...
            R = {"bicycle": [0.05390982, 0.05039431, 0.01863044, 1.29464435, 0.02713823, 0.01169572, 0.01295084],
